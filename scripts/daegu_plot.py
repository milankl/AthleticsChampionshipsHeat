...
ncfile = nc.Dataset(path+"daegu2011.nc")
...
ncfile = nc.Dataset(path+"daegu2011_fdir_i.nc")
...
utc2 = datetime.timedelta(hours=4)  # Korea standard time is UTC+9
...
f2 = ax.fill_between(time[1:],np.percentile(UTCI[:,1:,:],10,axis=(1,2)),np.percentile(UTCI[:,1:,:],90,axis=(1,2)),color="C3",alpha=0.5)
